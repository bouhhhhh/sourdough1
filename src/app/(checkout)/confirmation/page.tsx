		...
		if (redirectStatus === "succeeded" && paymentIntentId) {
			fetch(`/api/payment-intent?payment_intent=${paymentIntentId}`)
				...
				.then((data: any) => {
					...
					console.log("[CONFIRMATION] Extracted email:", {
						urlEmail,
						metaPayerEmail: meta.payerEmail,
						finalPayerEmail: payerEmail,
					});
					...
					if (!emailSentRef.current && !emailAlreadySent && payerEmail) {
						...
						console.log(
							"[CONFIRMATION] Not sending email. emailSent?",
			...
			console.log("[CONFIRMATION] Conditions not met for processing payment intent", {
				redirectStatus,
				paymentIntentId,
			});
		}
	...
	return (
		<div className="container py-10">
			<div className="max-w-2xl mx-auto text-center">
				...
				{shippingAddress && (
					<div className="mb-8">
						<ShippingMap address={shippingAddress.address} name={shippingAddress.name} />
					</div>
				)}
